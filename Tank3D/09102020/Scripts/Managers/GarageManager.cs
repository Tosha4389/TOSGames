...
public class GarageManager : MonoBehaviour
{
    ...
    {       
        loadParam.speedRotateTurret = turretUpd[id].speedRot;
        turretRend.sprite = loadParam.tankSprites[0] = turretSprites[id];        
    }

    public void ActiveUpgradeGun(int id)
    {
        loadParam.playerDamage = gunUpd[id].damage;
        loadParam.fireRate = gunUpd[id].fireRate;
        loadParam.scatter = gunUpd[id].scatter;
        loadParam.accuracy = gunUpd[id].accuracy;
    ...
    {
        loadParam.speedMove = chassisUpd[id].speedMove;
        loadParam.speedRotate = chassisUpd[id].speedRot;
