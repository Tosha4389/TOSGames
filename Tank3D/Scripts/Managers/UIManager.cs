...
public class UIManager : MonoBehaviour
{
    ...
    {
        hpStrip.transform.localScale = new Vector3(scale, hpStrip.transform.localScale.y, hpStrip.transform.localScale.y);
    }

    public void ShieldStripScale(float scale)
    {
        shieldStrip.transform.localScale = new Vector3(scale, hpStrip.transform.localScale.y, hpStrip.transform.localScale.y);
    }
