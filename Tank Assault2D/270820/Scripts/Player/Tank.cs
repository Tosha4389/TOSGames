...
public class Tank : MonoBehaviour
{
    ...
    {  
        if(Input.GetMouseButton(0) && reload == false) {
            Vector3 turretPos = turret.transform.localPosition + Vector3.up * 2.5f;
            ...
            Vector3 fire = turret.transform.localPosition + Vector3.up * 2f;
            Vector3 firePos = turret.transform.TransformPoint(fire);
            GameObject fireGO = Instantiate(firePrefab, firePos, turret.rotation);
